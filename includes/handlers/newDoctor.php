...
if(isset($_POST['register_button']) && ($type === "doctor")){
	...
	$_SESSION['reg_ssn'] = $ssn; //Stores ssn into session variable
	...
	if($em == $em2) {
		...
		if(filter_var($em, FILTER_VALIDATE_EMAIL)) {
			...
			$e_check = mysqli_query($con, "SELECT email FROM doctors WHERE email='$em'");
	...
	if(empty($error_array)) {
		...
		$query = mysqli_query($con, "INSERT INTO doctors VALUES ('$ssn', '$em', '$password', 1)");
