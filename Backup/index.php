<?php 
  ...
  //require 'includes/handlers/enqueue.php';
          ...
          <div class="modal-header">
            ...
            <h4>New Queue Number</h4>
                ...
                <div class="modal-body" >
                  ...
                  <select class="" name="" onchange="document.getElementById('selected_text').value=this.options[this.selectedIndex].text">
                    <?php 
                    ...
                    if(!$doctorsEntries){
                      ...
                      while($row = mysqli_fetch_array($doctorsEntries)){
                          echo "<option value=\"" . $i . "\">Dr " . $row['lname'] . "</option>";
                          $i = $i + 1;
                      }
                    ?>
                  </select>
      ...
      <div class="patientblock">
        ...
        <?php 
                  ...
                  if(!$doctorsEntries){
                    ...
                    while($row = mysqli_fetch_array($doctorsEntries)){
                         echo "<div>" . $i . "</div>" . "<div>" . $row['name'] . "</div>" . "<div>" . $row['lname'] . "</div>";
